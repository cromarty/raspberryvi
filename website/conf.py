...
BLOG_AUTHOR = raspberryvi.BLOG_AUTHOR
BLOG_TITLE = raspberryvi.BLOG_TITLE
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = raspberryvi.SITE_URL
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = raspberryvi.BLOG_EMAIL
BLOG_DESCRIPTION = raspberryvi.BLOG_DESCRIPTION
...
DEFAULT_LANG = raspberryvi.DEFAULT_LANG
...
NAVIGATION_LINKS = raspberryvi.NAVIGATION_LINKS

# Name of the theme to use.
THEME = raspberryvi.THEME
...
POSTS = raspberryvi.POSTS
PAGES = raspberryvi.PAGES
...
COMPILERS = raspberryvi.COMPILERS
...
LOGO_URL = raspberryvi.LOGO_URL

# If you want to hide the title of your website (for example, if your logo
# already contains the text), set this to False.
SHOW_BLOG_TITLE = raspberryvi.SHOW_BLOG_TITLE

# Writes tag cloud data in form of tag_cloud_data.json.
# Warning: this option will change its default value to False in v8!
WRITE_TAG_CLOUD = raspberryvi.WRITE_TAG_CLOUD
...
INDEX_PATH = raspberryvi.INDEX_PATH
...
USE_BASE_TAG = raspberryvi.USE_BASE_TAG
...
#     ]
# }
DEPLOY_COMMANDS = raspberryvi.DEPLOY_COMMANDS
...
INDEX_TEASERS = raspberryvi.INDEX_TEASERS
...
INDEX_READ_MORE_LINK = raspberryvi.INDEX_READ_MORE_LINK
# 'Read more...' for the feeds, if FEED_TEASERS is True (translatable)
FEED_READ_MORE_LINK = raspberryvi.FEED_READ_MORE_LINK

PATRONS = raspberryvi.PATRONS
...
CONTENT_FOOTER = raspberryvi.CONTENT_FOOTER
...
# (translatable)
CONTENT_FOOTER_FORMATS = raspberryvi.CONTENT_FOOTER_FORMATS

# To use comments, you can choose between different third party comment
# systems.  The following comment systems are supported by Nikola:
#   disqus, facebook, googleplus, intensedebate, isso, livefyre, muut
# You can leave this option blank to disable comments.
COMMENT_SYSTEM = raspberryvi.COMMENT_SYSTEM
# And you also need to add your COMMENT_SYSTEM_ID which
# depends on what comment system you use. The default is
# "nikolademo" which is a test account for Disqus. More information
# is in the manual.
COMMENT_SYSTEM_ID = raspberryvi.COMMENT_SYSTEM_ID
...
MARKDOWN_EXTENSIONS = raspberryvi.MARKDOWN_EXTENSIONS
...
SHOW_SOURCELINK = raspberryvi.SHOW_SOURCELINK
# Copy the source files for your pages?
# Setting it to False implies SHOW_SOURCELINK = False
COPY_SOURCES = raspberryvi.COPY_SOURCES
...
# set this to true.
UNSLUGIFY_TITLES = raspberryvi.UNSLUGIFY_TITLES
